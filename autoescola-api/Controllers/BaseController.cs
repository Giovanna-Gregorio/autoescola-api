...
namespace autoescola.Controllers
{
        ...
        where TModel : class, IModel<TIdType>
    {
        ...
        public BaseController(IServiceBase<TModel, TIdType> service, IHttpContextAccessor httpContextAccessor)
        {
            _service = service;
        ...
        protected int GetUsuarioClaims()
        {
            var http = _httpContextAccessor.HttpContext.User.Identity as ClaimsIdentity;
            var usuario = http.FindFirst("id").Value;
